...
const Journal: React.FC = () => {
  ...
  const getOrCreateDiaryEntry = (date: string) => {
    ...
    const lesson = lessons.find(l => l.date === date && l.subject === selectedSubject);
    const lessonNum = lesson ? lesson.lessonNumber : 1;
    const newEntry = { id: `de${Date.now()}`, date, lessonNumber: lessonNum, subject: selectedSubject, topic: '', homework: '' };
