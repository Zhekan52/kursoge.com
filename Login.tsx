      ...
      <div className="w-full max-w-md relative animate-scaleIn">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 space-y-8">
          ...
          <div className="border-t border-gray-100 pt-5 space-y-2">
            <p className="text-xs text-gray-400 text-center font-medium uppercase tracking-wider">Демо-доступ</p>
            <div className="grid grid-cols-2 gap-3">
              <button
                onClick={() => { setUsername('andreev'); setPassword('123456'); }}
                className="text-xs bg-gray-50 hover:bg-gray-100 text-gray-600 py-2.5 px-3 rounded-lg transition-colors border border-gray-200"
              >
                👨‍🎓 Ученик (andreev)
              </button>
              <button
